...
const PhotoGallery: React.FC = () => {
  return (
    <div className="container mx-auto  p-4">
      <div
        className="text-4xl font-bold leading-[63.98px] text-left text-[#004643] mb-4 font-playfair max-md:text-xl max-md:mb-0"
        style={{ fontFamily: "Playfair Display" }}
      >
        Gallery
      </div>

      <div className="grid lg:grid-cols-3 md:grid-cols-2  grid-cols-2  gap-1 mt-10 max-md:mt-4">
        ...
        <div className="grid grid-cols-1 gap-1 items-start">
          <div className="relative row-span-1 overflow-hidden rounded-lg">
            <Image
              src={img2}
              alt="Img02"
